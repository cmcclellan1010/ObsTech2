...
prefix_list = ['flat_1e4ms_', 'flat_1e5ms_', 'flat_2e5ms_', 'flat_3e4ms_', 'flat_6e4ms_', 'flat_12e4ms_']
...
# Plot variance vs signal
    y[i] = np.ndarray.flatten(variance)
    x[i] = np.ndarray.flatten(mean_array)
