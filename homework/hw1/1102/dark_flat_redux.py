...
hdu.writeto('master_dark_2s_1102.fit')

print "\nMaster dark image saved as 'master_dark_2s_1102.fit'."

flat_image_data = {}
for image_name in flat_list:
    flat_image_data[image_name] = fits.getdata(image_name)

hdu_list = fits.open('master_dark_2s_1102.fit')
...
hdu.writeto('master_flat_r_1102.fit')

print "\nNormalized master flat image saved as 'master_flat_r_1102.fit'."
